...
--
-- Host: 127.0.0.1
-- Tempo de geração: 24/05/2025 às 00:12
...
INSERT INTO `localizacao` (`ID_Localizacao`, `Nome`, `Descricao`) VALUES
(1, 'Setor A', 'Área de armazenamento identificada como Setor A'),
(2, 'Setor B', 'Área de armazenamento identificada como Setor B'),
(3, 'Setor C', 'Área de armazenamento identificada como Setor C'),
(4, 'Entrada', 'Área onde os medicamentos chegam ao estoque'),
(5, 'Estoque Central', 'Área principal de armazenamento dos medicamentos'),
(6, 'Saída', 'Área destinada à saída de medicamentos para distribuição');
...
--
ALTER TABLE `localizacao`
  MODIFY `ID_Localizacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
